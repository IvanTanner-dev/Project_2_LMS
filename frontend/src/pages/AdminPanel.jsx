...
const AdminPanel = () => {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      setUsers([
        { id: 1, username: "teacher_joe", email: "joe@example.com", role: "teacher", first_name: "Joe", last_name: "Teacher" },
        { id: 2, username: "student_ann", email: "ann@example.com", role: "student", first_name: "Ann", last_name: "Student" },
        { id: 3, username: "admin_user", email: "admin@example.com", role: "admin", first_name: "Admin", last_name: "User" },
      ]);
    } finally {
      setLoading(false);
    }
